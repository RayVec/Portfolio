  ...
  <div class="home">
    ...
    <div class="block">
      <div class="cover">
        <img
          class="img-full"
          src="https://raw.githubusercontent.com/RayVec/images/main/portfolio/projects/Keep-Shield-Project.png"
        />
      </div>
      <div class="title-zone">
        <div class="heading1">Keep Guard</div>
        <div class="text1 color2">
          An intern project aiming to design a community management system to
          enhance the content quality of Keep's community service.
        </div>
      ...
      <div class="profile-zone">
        <div class="profile">
          ...
          <div class="text2 color2">Desktop(main) & Mobile phone</div>
        </div>
        <div class="profile">
          <div class="text1">Role</div>
          <div class="text2 color2">Product designer & Product associate</div>
        </div>
        <div class="profile">
          <div class="text1">Date</div>
          <div class="text2 color2">October 2018 - February 2019</div>
        </div>
        <div class="profile">
          <div class="text1">Business area</div>
          <div class="text2 color2">
            Fitness<br />
            <a href="https://apps.apple.com/cn/app/id952694580" target="_blank"
              >Keep app</a
            >
          </div>
        </div>
      ...
      <!-- <div class="text2">
        ...
        <div style="text-align: center">
          <img
            ...
            src="https://img.freepik.com/premium-vector/e-mail-protection-anti-malware-anti-spam-concept-flat-vector-illustration_106788-2600.jpg?w=2000"
          />
        </div>
        <li>
          Cooperate with AI team to improve the correct rate and recall rate of
          AI review and labeling, then add auto-pending and auto-label process
          in order to significantly reduce human workload
        </li>
        <div style="text-align: center">
          <img
        ...
        <li>
          Short-term feedback can not be so precise to reflect the operating
          experience, we need to collect long-term feedback from operator and
          data report, iterating review and labeling experience to improve
          operators’ efficiency
        </li>
        <div style="text-align: center">
          <img
            style="width: 100%; margin: 0 auto"
            src="https://www.ag5.com/wp-content/uploads/2020/08/Blog54_Header-1000x351.png"
          />
        </div>
        <li>
          Build Keep’s own enterprise-level design system - long-term objective
        </li>
        <div style="text-align: center">
          <img
            style="width: 100%; margin: 0 auto"
            src="https://lh3.googleusercontent.com/WiCfewXIFrgIEcFyQ-6K44nFb96wx_K4Gj-YuQJlPGG3hLuUkQccgNzg2Et9d38xldm6TIVDmPGOnJiQBncKQyEx6D1BZ6FWufTPWhjjHrA6LYTYQJ4bOEq7wGsr8q6GJ_LxB6qF"
          />
        </div>
      </div> -->
    </div>
  ...
  methods: {
    ...
    openImage(index) {
      if (index === 1) {
        this.$viewerApi({
          images: [
            "https://raw.githubusercontent.com/RayVec/images/main/keep-guard/article/prototype-web.png",
          ],
        });
      }
      if (index === 2) {
...
.dot-animation-left {
  animation: roll-left 1.5s linear infinite;
}
.dot-animation-right {
  animation: roll-left 1.5s linear infinite;
}
...
.card1:hover .card1-shadow {
  transform: rotateY(0deg);
}

.card1:hover .card1-show {
  transform: rotateY(180deg);
}
/* @keyframes flip2 {
  0% {
