  ...
  <div class="home">
    ...
    <div class="block">
      <div class="cover">
        <img
          class="img-full"
          src="https://raw.githubusercontent.com/RayVec/images/main/portfolio/freetrial/cover-img.png"
        />
      </div>
      <div class="title-zone">
        <div class="heading1">Meituan Free Trial</div>
        <div class="text1 color2">
          An intern project aiming to update the current free trial service to
          attract more customer and help merchants accumulate more reviews
        </div>
      ...
      <div class="profile-zone">
        <div class="profile">
          ...
          <div class="text2 color2">Mobile phone & Desktop</div>
        </div>
        <div class="profile">
        ...
        <div class="profile">
          ...
          <div class="text2 color2">June 2018 - September 2018</div>
        </div>
        <div class="profile">
          <div class="text1">Business area</div>
          <div class="text2 color2">Life service, Merchant pass<br /></div>
        </div>
      </div>
    </div>
    <div class="block">
    ...
    <div class="block">
      ...
      <div class="text2">
        According to our user journey, we can conclude the following targets:
      </div>
      <div class="text2">
        <el-table :data="tableData" stripe border style="width: 100%">
          <el-table-column prop="phase" label="User journey phase">
          </el-table-column>
          <el-table-column prop="target" label="Core target"> </el-table-column>
  ...
  methods: {
    ...
    openImage(index) {
      if (index === 1) {
        this.$viewerApi({
          images: [
            "https://raw.githubusercontent.com/RayVec/images/main/portfolio/freetrial/prototype.png",
          ],
        });
      }
      if (index === 2) {
